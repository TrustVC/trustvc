...
TrustVC is a comprehensive wrapper library designed to simplify the signing and verification processes for TrustVC W3C [Verifiable Credentials (VC)](https://github.com/TrustVC/w3c/tree/alpha) and OpenAttestation Verifiable Documents (VD), adhering to the W3C [VC](https://www.w3.org/TR/vc-data-model/) Data Model v1.1 (W3C Standard). It ensures compatibility and interoperability for Verifiable Credentials while supporting OpenAttestation [Verifiable Documents (VD)](https://github.com/Open-Attestation/open-attestation/tree/beta) v6.10.0. TrustVC seamlessly integrates functionalities for handling W3C Verifiable Credentials and OpenAttestation Verifiable Documents, leveraging existing TradeTrust libraries and smart contracts for [Token Registry](https://github.com/TradeTrust/token-registry) (V4 and V5). Additionally, it includes essential utility functions for strings, networks, and chains, making it a versatile tool for developers working with decentralized identity and verifiable data solutions.
...
- [Functions](#functions)
  - [Wrapping](#wrapping)
    - [WrappingDocument](#wrappingdocument)
    - [WrappingDocuments](#wrappingdocuments)
  ...
  - [Decryption](#decryption)
    ...
    - [Errors](#errors-1)
    - [Usage](#usage-1)
- [TradeTrust Token Registry V4](#tradetrust-token-registry-v4)
  - [Usage](#usage-2)
...
- [TradeTrust Token Registry V5](#tradetrust-token-registry-v5)
  - [Usage](#usage-3)
  - [TradeTrustToken](#tradetrusttoken-1)
  - [Connect to Existing Token Registry](#connect-to-existing-token-registry-1)
    - [Issuing a Document](#issuing-a-document-1)
    - [Restoring a Document](#restoring-a-document-1)
    - [Accept/Burn a Document](#acceptburn-a-document-1)
...
- [Rejecting Transfers of Beneficiary/Holder](#rejecting-transfers-of-beneficiaryholder)
  - [Reject Transfer of Ownership](#reject-transfer-of-ownership)
  - [Reject Transfer of Holding](#reject-transfer-of-holding)
  - [Reject Both Roles (Ownership & Holding)](#reject-both-roles-ownership--holding)
...
For more information on Token Registry and Title Escrow contracts **version v5**, please visit the readme of [TradeTrust Token Registry V5](https://github.com/TradeTrust/token-registry/blob/master/README.md?plain=1)
