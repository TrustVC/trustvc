...
// Infura / Alchemy Free-tier eth_getLogs: max 10-block window (-32600).
...
export const RANGE_TOO_LARGE_ERROR_RE =
  /query returned more than|too large|block range|10,?000 results|response size|-32012|-32600|10\s*block|free tier|block difference|Upgrade to PAYG/i;

/** Hosts that reject wide eth_getLogs ranges on free plans (use adaptive chunked scan). */
export const INFURA_HOST_RE = /infura\.io|alchemy\.com/i;
