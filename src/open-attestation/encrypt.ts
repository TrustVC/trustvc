 ...
 * @param {number} ivLengthInBits Key length in bits
 * @returns {string} Base64-encoded initialisation vector
 */
 ...
 * @param {string} encryptionKey Encryption key in hexadecimal
 * @returns {{ cipher: forge.cipher.BlockCipher; encryptionKey: string; iv: string }} The cipher object, encryption key in hex, and iv in base64
 */
