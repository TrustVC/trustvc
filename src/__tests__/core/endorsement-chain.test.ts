...
const testCases = [
  ...
  },
  {
    ...
    description: 'Token Registry V5 with Transfer, Surrender, Burnt events - Amoy',
    tokenRegistryAddress: '0x3781bd0bbd15Bf5e45c7296115821933d47362be',
    tokenId: '0xe3fa2bbdbfd093d2bb4e1555dde01338af25d5cf1d6d87bd0f22d7302f133f9b',
    expected: [
      {
        type: 'INITIAL',
        transactionHash: '0x564f228ebf08139f53b3bc1d60b608a5c24b10998eaee54c4a06b83fbe123ddb',
        transactionIndex: 2,
        blockNumber: 20759943,
        owner: '0x433097a1C1b8a3e9188d8C54eCC057B1D69f1638',
        holder: '0x433097a1C1b8a3e9188d8C54eCC057B1D69f1638',
        timestamp: 1745306589000,
        remark: '�jP���ہ',
      },
    ],
    timeout: 60_000,
