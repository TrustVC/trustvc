...
const mockV5TitleEscrowFactoryContract = {
  callStatic: {
...
const mockV4TitleEscrowContract = {
  callStatic: {
    transferHolder: vi.fn(),
    transferBeneficiary: vi.fn(),
    transferOwners: vi.fn(),
...
const mockV4TradeTrustTokenContract = {
  titleEscrowFactory: vi.fn(() => Promise.resolve('0xV4titleescrowfactory')),
};

const PRIVATE_KEY = '0x59c6995e998f97a5a004497e5f1ebce0c16828d44b3f8d0bfa3a89d271d5b6b9'; // random local key

const providerV5 = new ethersV5.providers.JsonRpcProvider();
const providerV6 = new JsonRpcProviderV6();
