...
import { credentialStatusObligationRecordVerifier } from '../../verify/fragments/document-status/obligationRecords/obligationRecordVerifier';
import { ObligationRecordsStatusCode } from '../../verify/fragments/document-status/obligationRecords/obligationRecordVerifier.types';
import * as obligationUtils from '../../verify/fragments/document-status/obligationRecords/utils';
