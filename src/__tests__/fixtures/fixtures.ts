...
// Promissory note credential from documents/mainnet-pol.json.
// Signed with did:web:trustvc.github.io:did:1 using ecdsa-sd-2023.
...
export const W3C_TRANSFERABLE_RECORD_POL = freezeObject({
  ...
  credentialSubject: {
    ...
    amount: '50,000.00',
    clause:
      'Payment to be made in full without set-off or counterclaim, subject to terms agreed between Drawer and Drawee.',
    signerName: 'John Doe',
